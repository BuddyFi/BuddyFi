...
export const UserCard = ({ 
          ...
          <div className="flex-1">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center">
                <div className="h-16 w-16 rounded-full overflow-hidden border-2 border-purple-300 mr-3">
            ...
            <div className="mb-6">
              ...
              {user.githubUsername && (
                <a 
                  ...
                  className="inline-flex items-center text-sm text-gray-400 hover:text-purple-300 mb-4"
                >
  ...
  // Grid/List variant
  return (
    <div className="rounded-lg overflow-hidden backdrop-blur-xl bg-white/1 border border-white/10 shadow-[0_4px_12px_-2px_rgba(0,0,0,0.3)] hover:ring-1 hover:ring-purple-300/50 transition duration-300">
      <div className="h-24 bg-gradient-to-r from-purple-300/30 to-buddyfi-blue/30">
        {user.bannerImage && (
          <img 
      ...
      <div className="p-6 pt-0">
        <div className="flex justify-between -mt-8 mb-4">
          <div className="h-16 w-16 rounded-full overflow-hidden border-2 border-purple-300">
            <img src={user.avatar} alt={user.name} className="h-full w-full object-cover" />
          </div>
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          {user.skills.slice(0, 3).map((skill) => (
            <Badge key={skill} variant="secondary" className="skill-tag text-xs bg-purple-300/20">
              {skill}
            </Badge>
          ))}
          {user.skills.length > 3 && (
            <Badge variant="secondary" className="skill-tag text-xs bg-purple-300/10">
              +{user.skills.length - 3}
            </Badge>
          )}
        </div>
