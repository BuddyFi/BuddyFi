  ...
  useEffect(() => {
    ...
    fetch(`/api/adminbuddy?walletAddress=${publicKey.toString()}`)
      ...
      .then(({ users }) => {
        ...
        const latestProfilesByWallet = users.reduce((acc: { [key: string]: any }, current: { userData: { walletAddress: any; }; pinInfo: { date_pinned: string | number | Date; }; }) => {
        ...
        setUsers(Object.values(latestProfilesByWallet));
        setError(null);
      })
      .catch((error) => {
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <div className="flex flex-wrap gap-1">
                            {Array.isArray(user.userData.languages) &&
                            user.userData.languages.length > 0 ? (
                              <>
                                {user.userData.languages
                                  .slice(0, 3)
                                  .map((skill, i) => (
                                    <Badge
                                      key={i}
                                ...
                                {user.userData.languages.length > 3 && (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {Array.isArray(selectedUser.userData.languages) &&
                        selectedUser.userData.languages.length > 0 ? (
                          selectedUser.userData.languages.map((skill, i) => (
                            <Badge
                              key={i}
                    ...
                    {selectedUser.userData.githubProfile ? (
                      <div className="mt-4">
                        ...
                        <div className="space-y-2">
                          {selectedUser.userData.githubProfile && (
                            <a
                              href={`https://github.com/${selectedUser.userData.githubProfile}`}
                              target="_blank"
                          ...
                          {selectedUser.userData.twitter && (
                            <a
                              href={`https://twitter.com/${selectedUser.userData.twitter}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center text-gray-300 hover:text-purple-300"
                            >
                          ...
                          {selectedUser.userData.linkedin && (
                            <a
                              href={`https://linkedin.com/in/${selectedUser.userData.linkedin}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center text-gray-300 hover:text-purple-300"
                            >
